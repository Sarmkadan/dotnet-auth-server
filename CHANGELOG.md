...
- Multi-stage build removes SDK from final image, reducing size by ~60%

### Deprecated
- Direct non-containerized deployment is discouraged - use docker-compose for consistent environments
